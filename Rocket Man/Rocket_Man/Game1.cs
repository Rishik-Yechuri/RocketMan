...
namespace Rocket_Man
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            velocity += pad1.ThumbSticks.Left.Y * 0.2;
            if (velocity > 0)
            {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font1, "degrees:" + (int)degrees, new Vector2(0, 0), Color.White);
            spriteBatch.DrawString(font1, "velocity:" + (int)velocity, new Vector2(150, 0), Color.White);
